...
public class MainFrame extends JFrame implements RunningServerListener {
    ...
    private final JButton _clearBoxButton;
    ...
    public MainFrame(Settings settings) {
        ...
        setTitle("CE server pcileech 1.5");
        ...
        JLabel label = new JLabel("<html>This application must be run as an administrator when you read memory from vmware.</html>");
        ...
        JLabel portNumberDefaultLabel = new JLabel("(Default is " + Settings.DEFAULT_PORT_NUMBER + ")", SwingConstants.LEFT);
        ...
        _clearBoxButton = new JButton();
        _clearBoxButton.setFont(new Font(Font.SANS_SERIF, Font.BOLD, 18));
        _clearBoxButton.setFocusable(false);
        _clearBoxButton.setText("Clear Output");
        _clearBoxButton.setForeground(Color.WHITE);
        _clearBoxButton.setBackground(Color.GREEN.darker());
        buttonPanel.add(_clearBoxButton);
        ...
        _clearBoxButton.addActionListener(
            e -> _outputArea.setText("")
        );

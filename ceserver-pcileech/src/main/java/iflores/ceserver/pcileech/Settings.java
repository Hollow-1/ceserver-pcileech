...
public class Settings {
    ...
    public static final String DEFAULT_ARGUMENTS = "-printf -v -device vmware";
    public static final String ADAPTER_DLL_NAME = "ceserver_adapter";
    ...
    public static Settings load() {
        try {
            ...
            if (settingsBytes == null) {
                memprocfsExePath = "";
                pcileechArguments = DEFAULT_ARGUMENTS;
                ...
                portNumber = version >= 1 ? in.readInt() : DEFAULT_PORT_NUMBER;
            }
            return new Settings(
                    memprocfsExePath,
                    pcileechArguments,

...
public class ToolHelp32Snapshot_Modules {
    ...
    public void restartModuleInfo() {
        ...
        String executableName = Main.getLastPathComponent(_selectedProcess.getExecutableName());
        results.sort(Comparator.comparing(x -> ! executableName.equalsIgnoreCase(Main.getLastPathComponent(x.getUserObject().getName()))));
